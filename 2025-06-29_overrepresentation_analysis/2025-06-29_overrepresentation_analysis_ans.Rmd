...
How many significantly upregulated processes are there? 
First let's check the **unadjusted** P values and then see how the stringency is changed by adjusting for multiple measurements.
