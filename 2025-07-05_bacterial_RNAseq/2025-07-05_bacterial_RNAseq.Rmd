...
# create symlinks
lm -s /data/workshop-00/bact_raw/1-CL1_TAACTTGG-GTCGTGAA_L004_R1_001.fastq.gz S1_R1.fastq.gz
...
# count reads
htseq-count -f sam -t gene -i locus_tag /data/ws08/aligned_reads/S1_aligned.reads.sam /data/ws08/ncbi_dataset/data/GCF_000006765.1/genomic.gff > /data/ws08/htseq/S1_counts.tsv
```
...
```{r}
read.table("idmapping_2025_06_30.tsv",
           sep = "\t",
           header = TRUE,
           fill = TRUE) %>%
